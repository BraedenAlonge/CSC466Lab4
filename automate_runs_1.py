...
def main():
    ...
    # For hierarchical clustering: A dictionary mapping dataset filename to a default threshold.
    hclustering_params = {
        "data/4clusters.csv": 5.0,
    ...
    dbscan_params = {
        "data/4clusters.csv": {"epsilon": 1.0, "min_points": 5},
        "data/mammal_milk.csv": {"epsilon": 1.0, "min_points": 5},
        "data/planets.csv": {"epsilon": 1.0, "min_points": 5},
        "data/iris.csv": {"epsilon": 0.5, "min_points": 5},
        "data/AccidentsSet03.csv": {"epsilon": 1.0, "min_points": 5}
    }
